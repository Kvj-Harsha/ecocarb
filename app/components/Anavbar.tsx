    ...
    return (
        ...
        <nav aria-label="Global" className="hidden md:block">
          <ul className="flex items-center gap-6 text-sm">
            ...
            <button onClick={handleLogout} className="flex items-center gap-2 bg-gradient-to-r from-red-500 to-red-700 px-3 py-2 rounded-full text-white font-medium shadow-lg hover:from-red-600 hover:to-red-800 hover:shadow-xl focus:outline-none transition duration-300">
